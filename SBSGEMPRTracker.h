#ifndef SBSGEMPRTRACKER_H
#define SBSGEMPRTRACKER_H 1
#include <vector>
...
class SBSGEMPRTracker : public THaNonTrackingDetector, public SBSGEMTrackerBase {
 public:
  explicit SBSGEMPRTracker( const char *name, const char *description = "",
                                      THaApparatus *app = nullptr );

  virtual ~SBSGEMPRTracker();
