...
static string infile = "", outfile = ""; // = INFILE_DEFAULT; // = OUTFILE_DEFAULT;
...
int main( int argc, const char** argv )
{
  ...
  if(strcmp(infile.c_str(), "")==0){
    cout << "Please provide infile name !" << endl;
    return -1;
  }
  
  if(strcmp(outfile.c_str(), "")==0){
    cout << "Please provide outfile name !" << endl;
    return -1;
  }
  
  std::size_t found = outfile.find("tracker");
