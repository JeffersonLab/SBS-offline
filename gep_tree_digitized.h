...
// Sun Jun 16 18:27:17 2024 by ROOT version 6.30/04
// from TTree T/Geant4 SBS Simulation
// found on file: GEP1_elastic_nobkgd.root
//////////////////////////////////////////////////////////

#ifndef gep_tree_digitized_h
#define gep_tree_digitized_h
...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   std::vector<int>     *Earm_CDET_Scint_hit_wire;
   ...
   std::vector<double>  *Earm_CDET_Scint_hit_xhitg;
   std::vector<double>  *Earm_CDET_Scint_hit_yhitg;
   std::vector<double>  *Earm_CDET_Scint_hit_zhitg;
   ...
   std::vector<int>     *Earm_CDET_Scint_hit_otridx;
   std::vector<int>     *Earm_CDET_Scint_hit_ptridx;
   std::vector<int>     *Earm_CDET_Scint_hit_sdtridx;
   ...
   std::vector<int>     *Earm_ECalTF1_hit_wire;
   ...
   std::vector<double>  *Earm_ECalTF1_hit_xhitg;
   std::vector<double>  *Earm_ECalTF1_hit_yhitg;
   std::vector<double>  *Earm_ECalTF1_hit_zhitg;
   ...
   std::vector<int>     *Earm_ECalTF1_hit_otridx;
   std::vector<int>     *Earm_ECalTF1_hit_ptridx;
   std::vector<int>     *Earm_ECalTF1_hit_sdtridx;
   ...
   std::vector<int>     *Harm_FPP1_hit_otridx;
   std::vector<int>     *Harm_FPP1_hit_ptridx;
   std::vector<int>     *Harm_FPP1_hit_sdtridx;
   ...
   std::vector<int>     *Harm_FPP1_Track_otridx;
   std::vector<int>     *Harm_FPP1_Track_ptridx;
   std::vector<int>     *Harm_FPP1_Track_sdtridx;
   ...
   std::vector<int>     *Harm_FT_hit_otridx;
   std::vector<int>     *Harm_FT_hit_ptridx;
   std::vector<int>     *Harm_FT_hit_sdtridx;
   ...
   std::vector<int>     *Harm_FT_Track_otridx;
   std::vector<int>     *Harm_FT_Track_ptridx;
   std::vector<int>     *Harm_FT_Track_sdtridx;
   ...
   Int_t           Earm_ECal_dighit_nchan;
   std::vector<int>     *Earm_ECal_dighit_chan;
   std::vector<int>     *Earm_ECal_dighit_adc;
   std::vector<int>     *Earm_ECal_dighit_samp;
   std::vector<int>     *Earm_ECal_dighit_tdc;
   Int_t           Earm_CDET_dighit_nchan;
   std::vector<int>     *Earm_CDET_dighit_chan;
   std::vector<int>     *Earm_CDET_dighit_adc;
   std::vector<int>     *Earm_CDET_dighit_tdc_l;
   std::vector<int>     *Earm_CDET_dighit_tdc_t;
   Int_t           Harm_FT_dighit_nstrips;
   std::vector<int>     *Harm_FT_dighit_module;
   std::vector<int>     *Harm_FT_dighit_strip;
   std::vector<int>     *Harm_FT_dighit_adc;
   std::vector<int>     *Harm_FT_dighit_samp;
   std::vector<double>  *Harm_FT_dighit_mcfrac;
   ...
   std::vector<double>  *Harm_FPP1_dighit_mcfrac;
   ...
   TBranch        *b_Earm_ECal_dighit_nchan;   //!
   TBranch        *b_Earm_ECal_dighit_chan;   //!
   TBranch        *b_Earm_ECal_dighit_adc;   //!
   TBranch        *b_Earm_ECal_dighit_samp;   //!
   TBranch        *b_Earm_ECal_dighit_tdc;   //!
   TBranch        *b_Earm_CDET_dighit_nchan;   //!
   TBranch        *b_Earm_CDET_dighit_chan;   //!
   TBranch        *b_Earm_CDET_dighit_adc;   //!
   TBranch        *b_Earm_CDET_dighit_tdc_l;   //!
   TBranch        *b_Earm_CDET_dighit_tdc_t;   //!
   TBranch        *b_Harm_FT_dighit_nstrips;   //!
   TBranch        *b_Harm_FT_dighit_module;   //!
   TBranch        *b_Harm_FT_dighit_strip;   //!
   TBranch        *b_Harm_FT_dighit_adc;   //!
   TBranch        *b_Harm_FT_dighit_samp;   //!
   TBranch        *b_Harm_FT_dighit_mcfrac;   //!
   ...
   TBranch        *b_Harm_FPP1_dighit_mcfrac;   //!
...
#ifdef gep_tree_digitized_cxx
gep_tree_digitized::gep_tree_digitized(TTree *tree) : fChain(0) 
{
// if parameter tree is not specified (or zero), connect the file
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("GEP1_elastic_nobkgd.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("GEP1_elastic_nobkgd.root");
      }
      f->GetObject("T",tree);
...
gep_tree_digitized::~gep_tree_digitized()
{
   if (!fChain) return;
   delete fChain->GetCurrentFile();
}

Int_t gep_tree_digitized::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t gep_tree_digitized::LoadTree(Long64_t entry)
{
...
void gep_tree_digitized::Init(TTree *tree)
{
   ...
   Earm_ECal_dighit_chan = 0;
   Earm_ECal_dighit_adc = 0;
   Earm_ECal_dighit_samp = 0;
   Earm_ECal_dighit_tdc = 0;
   Earm_CDET_dighit_chan = 0;
   Earm_CDET_dighit_adc = 0;
   Earm_CDET_dighit_tdc_l = 0;
   Earm_CDET_dighit_tdc_t = 0;
   Harm_FT_dighit_module = 0;
   Harm_FT_dighit_strip = 0;
   Harm_FT_dighit_adc = 0;
   Harm_FT_dighit_samp = 0;
   Harm_FT_dighit_mcfrac = 0;
   Harm_FPP1_dighit_module = 0;
   Harm_FPP1_dighit_strip = 0;
   Harm_FPP1_dighit_adc = 0;
   Harm_FPP1_dighit_samp = 0;
   Harm_FPP1_dighit_mcfrac = 0;
   ...
   fChain->SetBranchAddress("Earm.ECal.dighit.nchan", &Earm_ECal_dighit_nchan, &b_Earm_ECal_dighit_nchan);
   fChain->SetBranchAddress("Earm.ECal.dighit.chan", &Earm_ECal_dighit_chan, &b_Earm_ECal_dighit_chan);
   fChain->SetBranchAddress("Earm.ECal.dighit.adc", &Earm_ECal_dighit_adc, &b_Earm_ECal_dighit_adc);
   fChain->SetBranchAddress("Earm.ECal.dighit.samp", &Earm_ECal_dighit_samp, &b_Earm_ECal_dighit_samp);
   fChain->SetBranchAddress("Earm.ECal.dighit.tdc", &Earm_ECal_dighit_tdc, &b_Earm_ECal_dighit_tdc);
   fChain->SetBranchAddress("Earm.CDET.dighit.nchan", &Earm_CDET_dighit_nchan, &b_Earm_CDET_dighit_nchan);
   fChain->SetBranchAddress("Earm.CDET.dighit.chan", &Earm_CDET_dighit_chan, &b_Earm_CDET_dighit_chan);
   fChain->SetBranchAddress("Earm.CDET.dighit.adc", &Earm_CDET_dighit_adc, &b_Earm_CDET_dighit_adc);
   fChain->SetBranchAddress("Earm.CDET.dighit.tdc_l", &Earm_CDET_dighit_tdc_l, &b_Earm_CDET_dighit_tdc_l);
   fChain->SetBranchAddress("Earm.CDET.dighit.tdc_t", &Earm_CDET_dighit_tdc_t, &b_Earm_CDET_dighit_tdc_t);
   fChain->SetBranchAddress("Harm.FT.dighit.nstrips", &Harm_FT_dighit_nstrips, &b_Harm_FT_dighit_nstrips);
   fChain->SetBranchAddress("Harm.FT.dighit.module", &Harm_FT_dighit_module, &b_Harm_FT_dighit_module);
   ...
   //fChain->SetBranchAddress("Harm.FT.dighit.mcfrac", &Harm_FT_dighit_mcfrac, &b_Harm_FT_dighit_mcfrac);
   ...
   //fChain->SetBranchAddress("Harm.FPP1.dighit.mcfrac", &Harm_FPP1_dighit_mcfrac, &b_Harm_FPP1_dighit_mcfrac);
   Notify();
}

Bool_t gep_tree_digitized::Notify()
{
...
void gep_tree_digitized::Show(Long64_t entry)
{
...
Int_t gep_tree_digitized::Cut(Long64_t entry)
{
...
#endif // #ifdef gep_tree_digitized_cxx
