...
class SBSECal : public THaPidDetector {

 public:
  SBSECal( const char* name, const char* description = "",
	     THaApparatus* a = NULL );
  virtual ~SBSECal();
  ...
  virtual Int_t      FineProcess(TClonesArray& tracks);
	  ...
	  SBSECalCluster* GetClust(Int_t i) { return fClusters[i]; }
  
	  void       AddCluster(SBSECalCluster* clus);
 ...
 protected:
  ...
  ClassDef(SBSECal,0)     //Generic shower detector class
};
