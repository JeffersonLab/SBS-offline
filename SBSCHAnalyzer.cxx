//////////////////////////////////////////////////////////////////////////
//
// SBSCHAnlayzer class implementation
//
//////////////////////////////////////////////////////////////////////////

#include "SBSCHAnalyzer.h"

ClassImp(SBSCHAnalyzer);

/*
 * SBSCHAnalyzer constructor.
 *
 * Use a TDC with trailing edge info, default is no ADC, but available for
 * commissioning only
 */
SBSCHAnalyzer::SBSCHAnalyzer( const char* name, const char* description,
...
///////////////////////////////////////////////////////////////////////////////
/// Read SBSCHAnalyzer Database
Int_t SBSCHAnalyzer::ReadDatabase( const TDatime& date )
{
...
Int_t SBSCHAnalyzer::DefineVariables( EMode mode )
{
  ...
  RVarDef vars[] = {
   ...
   { "hit.adc",     " PMT hit ADC",        "fHits.SBSRPBeamSideHodo_Hit.GetADC()"   },
   { "hit.tdc",     " PMT hit TDC",        "fHits.SBSRPBeamSideHodo_Hit.GetTDC()"   },
   { 0 }
  };
 ...
 * FindGoodHit()
 */
Int_t SBSCHAnalyzer::FindGoodHit(SBSElement *)
{
...
Int_t SBSCHAnalyzer::CoarseProcess( TClonesArray& tracks )
{
  if(fCoarseProcessed)
    return 0;
...
Int_t SBSCHAnalyzer::FineProcess( TClonesArray& tracks )
{
