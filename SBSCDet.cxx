...
SBSCDet::SBSCDet( ) : THaSubDetector("plane","scintplane",0),
...
//_____________________________________________________________________________
THaAnalysisObject::EStatus SBSCDet::Init( const TDatime& date )
{
...
//_____________________________________________________________________________
Double_t SBSCDet::TimeWalkCorrection( THaScintPMT* pmt, Double_t ADC, Double_t time)
{
...
Int_t SBSCDet::Decode( const THaEvData& evdata )
{
    ...
    if (i!=GetNRefCh()) {
        clog<<"SBSCDet::Decode : Mismatch between fNRefCh and hits on RefLines"<<endl;
...
//_____________________________________________________________________________
const THaTdcHit* SBSCDet::GetBarHitT(const char side,
...
//_____________________________________________________________________________
const THaAdcHit* SBSCDet::GetBarHitA(const char side,
                                           const THaScintBar *const ptr,
                                           const int n) const
{
